...
ENV=imm
REPOSITORY_FOLDER=$(cat /home/ec2-user/SageMaker/mariano/repositories/train-test-split/two-phase-scal-ng20-train-test/config/repository_path.txt)
...
for N in 1506 3012 3766 7531 11297 15062 # 753 1506 3012 3766  7531  11297  15062 #  -------->  %5    10%    %20    %25    %50    %75 %100
do
